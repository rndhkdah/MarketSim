...
def test_losing_bids_pay_nothing() -> None:
    bids = (
        Bid("alice", 0.040, 10.0),  # wins (below stop)
        Bid("bob", 0.080, 10.0),  # asks too much yield; loses
    )
    result = clear_uniform(10.0, bids, y_fair=0.042, q0=100.0)
...
def test_winning_bids_settle_and_govt_dep_nonneg() -> None:
    ...
    result = clear_uniform(30.0, (Bid("alice", 0.041, 10.0),), y_fair=0.042, q0=40.0)
