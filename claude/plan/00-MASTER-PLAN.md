...
| `dynamics.yaml` | T2.01 | production modes, inventory/backlog, price formation, capex unit contract, households, labour, fiscal, ROW, NPC entry/exit (T3.14) |
...
| `wants.yaml`, `buy_packages.yaml` | T3.08–T3.11 | wants → sectors, need shapes, tiers (generated by the calibrator) |
